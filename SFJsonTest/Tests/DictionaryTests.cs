...
namespace SFJsonTest
{
    ...
    public class DictionaryTests
    {
        ...
        public void CanConvertObjectWithObjectDicitonary()
        {
            ...
            Assert.AreEqual("{\"$type\":\"SFJsonTest.ObjectWithObjectDictionary, SFJsonTest\",\"Dictionary\":[\"$type\":\"System.Collections.Generic.Dictionary`2[[SFJsonTest.SimpleTestObject, SFJsonTest],[SFJsonTest.SimpleTestObject, SFJsonTest]], mscorlib\",\"$values\":[{\"{\\\"$type\\\":\\\"SFJsonTest.SimpleTestObject, SFJsonTest\\\"}\":{\"$type\":\"SFJsonTest.SimpleTestObject, SFJsonTest\"}},{\"{\\\"$type\\\":\\\"SFJsonTest.SimpleTestObject, SFJsonTest\\\"}\":{\"$type\":\"SFJsonTest.SimpleTestObject, SFJsonTest\"}},{\"{\\\"$type\\\":\\\"SFJsonTest.SimpleTestObject, SFJsonTest\\\"}\":{\"$type\":\"SFJsonTest.SimpleTestObject, SFJsonTest\"}}]]}", strWithType);
