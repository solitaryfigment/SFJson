...
namespace SFJsonTests
{
    ...
    public class TimeObjectTests
    {
        ...
        public void CanConvertDateTimeObjectType()
        {
            ...
            Assert.AreEqual("{\"$type\":\"SFJsonTests.DateTimeObject, SFJsonTests\",\"DateTime\":\"2010-10-09T01:02:03.500\",\"DateTimeOffset\":\"2010-10-09T01:02:03.500 +01:01\"}", strWithType);
        ...
        public void CanConvertDateTimeObjectTypeWithFormatting()
        {
            ...
            var strWithType = _serializer.Serialize(obj, new SerializerSettings() { SerializationTypeHandle = SerializationTypeHandle.All, DateTimeFormat = "yyyy-MM-dd", DateTimeOffsetFormat = "yyyy-MM-dd zzz" });

            Console.WriteLine(str);
            Console.WriteLine(strWithType);
            
            Assert.AreEqual("{\"DateTime\":\"2010-10-09\",\"DateTimeOffset\":\"2010-10-09 +01:01\"}", str);
            Assert.AreEqual("{\"$type\":\"SFJsonTests.DateTimeObject, SFJsonTests\",\"DateTime\":\"2010-10-09\",\"DateTimeOffset\":\"2010-10-09 +01:01\"}", strWithType);
        ...
        public void CanConvertTimeSpanObjectType()
        {
            ...
            Assert.AreEqual("{\"$type\":\"SFJsonTests.TimeSpanObject, SFJsonTests\",\"TimeSpan\":\"760.00:00:00\"}", strWithType);
