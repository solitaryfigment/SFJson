...
namespace SFJsonTests
{
    ...
    public class IgnoreTests
    {
        ...
        public void WillProperlyHandleSerializingIgnoredMembers()
        {
            ...
            Assert.AreEqual("{\"$type\":\"SFJsonTests.ObjectWithIgnoredMembers, SFJsonTests\",\"FieldInt\":13,\"PropInt\":12}", strWithType);
        ...
        public void WillProperlyHandleDeserializingIgnoredMembers()
        {
            ...
            var strWithType = "{\"$type\":\"SFJsonTests.ObjectWithIgnoredMembers, SFJsonTests\",\"FieldInt\":13,\"PropInt\":12,\"PropIgnoredInt\":32,\"FieldIgnoredInt\":33}";
        ...
        public void WillProperlyHandleSerializingIgnoredObjectMembers()
        {
            ...
            Assert.AreEqual("{\"$type\":\"SFJsonTests.ObjectWithIgnoredObjectMembers, SFJsonTests\",\"PropObject\":{\"$type\":\"SFJsonTests.ObjectWithIgnoredMembers, SFJsonTests\",\"FieldInt\":13,\"PropInt\":12}}", strWithType);
        ...
        public void WillProperlyHandleDeserializingIgnoredObjectMembers()
        {
            ...
            var strWithType = "{\"$type\":\"SFJsonTests.ObjectWithIgnoredObjectMembers, SFJsonTests\",\"PropObject\":{\"$type\":\"SFJsonTests.ObjectWithIgnoredMembers, SFJsonTests\",\"FieldInt\":13,\"PropInt\":12}}";
