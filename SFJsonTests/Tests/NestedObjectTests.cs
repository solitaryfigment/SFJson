...
namespace SFJsonTests
{
    ...
    public class NestedObjectTests
    {
        ...
        public void CanConvertNestedObjects()
        {
            ...
            Assert.AreEqual("{\"$type\":\"SFJsonTests.ObjectWithNestedType+NestedClass, SFJsonTests\",\"PropString\":\"Nested\"}", strWithType);
        ...
        public void CanConvertReferenceNestedObjects()
        {
            ...
            Assert.AreEqual("{\"$type\":\"SFJsonTests.ObjectWithNestedType, SFJsonTests\",\"PropNested\":{\"$type\":\"SFJsonTests.ObjectWithNestedType+NestedClass, SFJsonTests\",\"PropString\":\"Nested\"},\"PropInt\":100}", strWithType);
        ...
        public void CanConvertNestedNestedObjects()
        {
            ...
            Console.WriteLine(strWithType);
            Assert.AreEqual("{\"PropString\":\"Nested\"}", str);   
            Assert.AreEqual("{\"$type\":\"SFJsonTests.ObjectWithNestedNestedType+NestedClass+NestedNestedClass, SFJsonTests\",\"PropString\":\"Nested\"}", strWithType);
        ...
        public void CanConvertReferenceNestedNestedObjects()
        {
            ...
            Assert.AreEqual("{\"$type\":\"SFJsonTests.ObjectWithNestedNestedType, SFJsonTests\",\"PropNested\":{\"$type\":\"SFJsonTests.ObjectWithNestedNestedType+NestedClass, SFJsonTests\",\"PropNested\":{\"$type\":\"SFJsonTests.ObjectWithNestedNestedType+NestedClass+NestedNestedClass, SFJsonTests\",\"PropString\":\"Nested\"}}}", strWithType);
