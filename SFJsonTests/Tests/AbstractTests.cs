...
namespace SFJsonTests
{
    ...
    public class AbstractTests : BaseTestClass
    {
        ...
        [TestCase(false, SerializationTypeHandle.Objects, null, "{\"$type\":\"SFJsonTests.ObjectWithAbstractClass, SFJsonTests\",\"ObjectImplementingAbstractClass\":{\"$type\":\"SFJsonTests.ObjectImplementingAbstractClass, SFJsonTests\",\"AbstractPropInt\":50,\"PropInt\":100}}")]
        [TestCase(false, SerializationTypeHandle.All, null, "{\"$type\":\"SFJsonTests.ObjectWithAbstractClass, SFJsonTests\",\"ObjectImplementingAbstractClass\":{\"$type\":\"SFJsonTests.ObjectImplementingAbstractClass, SFJsonTests\",\"AbstractPropInt\":50,\"PropInt\":100}}")]
        ...
        [TestCase(true, SerializationTypeHandle.Objects, null, "{\n\t\"$type\" : \"SFJsonTests.ObjectWithAbstractClass, SFJsonTests\",\n\t\"ObjectImplementingAbstractClass\" : {\n\t\t\"$type\" : \"SFJsonTests.ObjectImplementingAbstractClass, SFJsonTests\",\n\t\t\"AbstractPropInt\" : 50,\n\t\t\"PropInt\" : 100\n\t}\n}")]
