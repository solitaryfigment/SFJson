...
namespace SFJsonTests
{
    ...
    public class InterfaceTests
    {
        ...
        public void CanConvertObjectWithInterface()
        {
            ...
            Assert.AreEqual("{\"$type\":\"SFJsonTests.ObjectWithInterface, SFJsonTests\",\"ObjectImplementingInterface\":{\"$type\":\"SFJsonTests.ObjectImplementingInterface, SFJsonTests\",\"InterfacePropInt\":50,\"PropInt\":100}}", strWithType);
        ...
        public void CanConvertInterface()
        {
            ...
            Assert.AreEqual("{\"$type\":\"SFJsonTests.ObjectImplementingInterface, SFJsonTests\",\"InterfacePropInt\":50,\"PropInt\":100}", strWithType);
