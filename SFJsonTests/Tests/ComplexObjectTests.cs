...
namespace SFJsonTests
{
    ...
    public class ComplexObjectTests
    {
        ...
        public void CanConvertCompositeObjects()
        {
            ...
            Assert.AreEqual("{\"$type\":\"SFJsonTests.ComplexObject, SFJsonTests\",\"Inner\":{\"$type\":\"SFJsonTests.SelfReferencedSimpleObject, SFJsonTests\",\"Inner\":{\"$type\":\"SFJsonTests.SelfReferencedSimpleObject, SFJsonTests\",\"Inner\":null}},\"SimpleTestObject\":{\"$type\":\"SFJsonTests.SimpleTestObject, SFJsonTests\"},\"SimpleTestObjectWithProperties\":{\"$type\":\"SFJsonTests.SimpleTestObjectWithProperties, SFJsonTests\",\"FieldInt\":20,\"TestInt\":10},\"PrimitiveHolder\":{\"$type\":\"SFJsonTests.PrimitiveHolder, SFJsonTests\",\"PropBool\":false,\"PropDouble\":100.1,\"PropFloat\":1.1,\"PropInt\":25,\"PropString\":\"String\"}}", strWithType);
