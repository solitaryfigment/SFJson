...
namespace SFJsonTests
{
    ...
    public class BasicObjectTests
    {
        ...
        public void CanConvertComplexString()
        {
            ...
            Assert.AreEqual("{\"$type\":\"SFJsonTests.StringObject, SFJsonTests\",\"String\":\"{[This:\\\"is \\\"\\\" a\\\",string]}\"}", strWithType);
        ...
        public void CanConvertPrimitiveProperties()
        {
            ...
            Assert.AreEqual("{\"$type\":\"SFJsonTests.PrimitiveHolder, SFJsonTests\",\"PropBool\":true,\"PropDouble\":100.1,\"PropFloat\":1.1,\"PropInt\":25,\"PropString\":\"1\"}", strWithType);
        ...
        public void CanConvertSimpleObjectWithProperties()
        {
            ...
            Assert.AreEqual("{\"$type\":\"SFJsonTests.SimpleTestObjectWithProperties, SFJsonTests\",\"FieldInt\":20,\"TestInt\":10}", strWithType);
        ...
        public void CanConvertGuid()
        {
            ...
            Assert.AreEqual(string.Format("{0}\"$type\":\"SFJsonTests.GuidHolder, SFJsonTests\",\"PropGuid\":\"{1}\"{2}",'{',obj.PropGuid,'}'), strWithType);
        ...
        public void CanConvertSelfReferencedSimpleObjectType()
        {
            ...
            Assert.AreEqual("{\"$type\":\"SFJsonTests.SelfReferencedSimpleObject, SFJsonTests\",\"Inner\":{\"$type\":\"SFJsonTests.SelfReferencedSimpleObject, SFJsonTests\",\"Inner\":null}}", strWithType);
        ...
        public void CanConvertNullString()
        {
            ...
            Assert.AreEqual("{\"$type\":\"SFJsonTests.StringHolder, SFJsonTests\",\"PropString\":null}", strWithType);
        ...
        public void CanConvertEmptyString()
        {
            ...
            Assert.AreEqual("{\"$type\":\"SFJsonTests.StringHolder, SFJsonTests\",\"PropString\":\"\"}", strWithType);
        ...
        public void CanConvertNumberPrimitiveProperties()
        {
            ...
            Assert.AreEqual("{\"$type\":\"SFJsonTests.PrimitiveHolder2, SFJsonTests\",\"PropDecimal\":3.2,\"PropByte\":255,\"PropSByte\":127,\"PropUInt\":4294967295,\"PropUInt16\":65535,\"PropInt16\":32767,\"PropUInt32\":4294967295,\"PropInt32\":2147483647,\"PropUInt64\":18446744073709551615,\"PropInt64\":9223372036854775807}", strWithType);
